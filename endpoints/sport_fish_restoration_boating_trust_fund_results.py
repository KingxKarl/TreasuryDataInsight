...
endpoint_details = {
    ...
    'params': {
        'fields': ','.join([
            'record_date', 'fiscal_year', 'table_nbr', 'table_nm', 'account_desc', 'component_desc', 'line_item_desc', 
            'fiscal_year_amt', 'src_line_nbr', 'record_fiscal_year', 'record_fiscal_quarter', 'record_calendar_year', 
