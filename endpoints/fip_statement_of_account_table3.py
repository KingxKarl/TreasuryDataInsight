...
def format_data(data):
    ...
    numeric_cols = [
        'principal_inflation_comp', 'unrealized_discount', 'premium_discount_recognized',
        'interest_inflation_earnings', 'total_investments', 'total_redemptions', 'total_inflation_purchased_sold'
    ]
...
endpoint_details = {
    ...
    'params': {
        'fields': ','.join([
            'record_date', 'account_number_tas', 'account_name', 'date_range', 'trans_date', 'memo_no',
            'sub_category', 'principal_inflation_comp', 'unrealized_discount', 'premium_discount_recognized',
            'interest_inflation_earnings', 'total_investments', 'total_redemptions', 'total_inflation_purchased_sold',
