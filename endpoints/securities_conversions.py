...
def format_data(data):
    ...
    numeric_cols = [
        'paper_sb_conversions_cnt', 'paper_sb_conversions_amt'
    ]
...
endpoint_details = {
    ...
    'params': {
        'fields': ','.join([
            'record_date', 'security_class_desc', 'paper_sb_conversions_cnt', 
            'paper_sb_conversions_amt', 'trans_month', 'src_line_nbr', 
