...
def format_data(data):
    ...
    numeric_cols = [
        'current_month_gross_outly_amt', 'current_month_app_rcpt_amt', 'current_month_net_outly_amt',
        'current_fytd_gross_outly_amt', 'current_fytd_app_rcpt_amt', 'current_fytd_net_outly_amt',
        'prior_fytd_gross_outly_amt', 'prior_fytd_app_rcpt_amt', 'prior_fytd_net_outly_amt'
    ]
