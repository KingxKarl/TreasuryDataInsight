...
def format_data(data):
    ...
    df['fiscal_year_thous_amt'] = pd.to_numeric(df['fiscal_year_thous_amt'].str.replace(',', '').str.replace('$', ''), errors='coerce')
...
endpoint_details = {
    ...
    'params': {
        'fields': ','.join([
            ...
            'component_desc', 'fiscal_year_thous_amt', 'src_line_nbr', 'record_fiscal_year',
