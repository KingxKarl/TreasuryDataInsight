...
def format_data(data):
    ...
    numeric_cols = [
        'current_month_rcpt_outly_amt', 'current_fytd_rcpt_outly_amt', 'prior_fytd_rcpt_outly_amt',
...
endpoint_details = {
    ...
    'params': {
        'fields': ','.join([
            ...
            'current_month_rcpt_outly_amt', 'current_fytd_rcpt_outly_amt', 'prior_fytd_rcpt_outly_amt',
            'current_year_budget_est_amt', 'table_nbr', 'src_line_nbr', 'print_order_nbr', 'line_code_nbr',
            'data_type_cd', 'record_type_cd', 'sequence_level_nbr', 'sequence_number_cd', 'record_fiscal_year',
