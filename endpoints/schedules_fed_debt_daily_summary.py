...
def format_data(data):
    ...
    numeric_cols = [
        'public_principal_mil_amt', 'public_accr_int_pay_mil_amt', 'public_net_unamortized_mil_amt',
        'intragov_principal_mil_amt', 'intragov_accr_int_pay_mil_amt', 'intragov_net_unamort_mil_amt'
    ]
...
endpoint_details = {
    ...
    'params': {
        'fields': ','.join([
            'record_date', 'public_principal_mil_amt', 'public_accr_int_pay_mil_amt', 'public_net_unamortized_mil_amt',
            'intragov_principal_mil_amt', 'intragov_accr_int_pay_mil_amt', 'intragov_net_unamort_mil_amt', 'src_line_nbr', 
