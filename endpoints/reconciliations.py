...
endpoint_details = {
    ...
    'params': {
        'fields': ','.join([
            'record_date', 'stmt_fiscal_year', 'restmt_flag', 'account_desc', 'component_desc',
            'line_item_desc', 'position_bil_amt', 'src_line_nbr', 'record_fiscal_year', 'record_fiscal_quarter',
