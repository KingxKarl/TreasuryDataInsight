...
def format_data(data):
    ...
    numeric_cols = [
        'non_dedicated_funds_bil_amt', 'dedicated_funds_bil_amt', 'eliminations_bil_amt',
...
endpoint_details = {
    ...
    'params': {
        'fields': ','.join([
            'record_date', 'stmt_fiscal_year', 'restmt_flag', 'account_desc', 
            'line_item_desc', 'non_dedicated_funds_bil_amt', 'dedicated_funds_bil_amt', 'eliminations_bil_amt',
            'consolidated_bil_amt', 'src_line_nbr', 'record_fiscal_year', 'record_fiscal_quarter',
