'''
Data Table Name: Operating Cash Balance
'''
...
Description: The type of account with an operating cash balance.
Data Type: STRING
Is Required: 1
'''
...
endpoint_details = {
    ...
    'params': {
        'fields': ','.join([
            ...
            'open_month_bal', 'open_fiscal_year_bal', 'table_nbr', 'table_nm',
