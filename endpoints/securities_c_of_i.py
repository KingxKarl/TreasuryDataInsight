...
def format_data(data):
    ...
    df['outstanding_cert_indebt_amt'] = pd.to_numeric(df['outstanding_cert_indebt_amt'].str.replace(',', '').str.replace('$', ''), errors='coerce')
...
endpoint_details = {
    ...
    'params': {
        'fields': ','.join([
            'record_date', 'outstanding_cert_indebt_amt', 'trans_month', 'src_line_nbr', 
