...
def format_data(data):
    ...
    numeric_cols = [
        'gross_cost_bil_amt', 'earned_revenue_bil_amt', 'subtotal_bil_amt', 'change_assumptions_bil_amt', 
        'net_cost_bil_amt'
    ]
...
endpoint_details = {
    ...
    'params': {
        'fields': ','.join([
            'record_date', 'stmt_fiscal_year', 'restmt_flag', 'agency_nm', 'gross_cost_bil_amt', 'earned_revenue_bil_amt', 
            'subtotal_bil_amt', 'change_assumptions_bil_amt', 'net_cost_bil_amt', 'src_line_nbr', 'record_fiscal_year', 
