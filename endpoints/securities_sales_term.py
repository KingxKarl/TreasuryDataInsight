...
def format_data(data):
    ...
    numeric_cols = [
        'security_term_nbr', 'securities_sold_cnt', 'securities_sold_amt'
    ]
...
endpoint_details = {
    ...
    'params': {
        'fields': ','.join([
            'record_date', 'security_type_desc', 'security_class_desc', 'security_term_nbr',
            'securities_sold_cnt', 'securities_sold_amt', 'from_cert_of_indebt_ind', 
            'trans_month', 'src_line_nbr', 'record_fiscal_year', 'record_fiscal_quarter', 
