'''
Data Table Name: Federal Tax Deposits
'''
...
# Field Name: tax_deposit_type
'''
Display Name: Federal

 Tax Deposit Type
Description: Tier one of a two-tier hierarchy for capturing federal tax deposits from various sources.
Data Type: STRING
Is Required: 
'''

# Field Name: tax_deposit_type_desc
'''
Display Name: Federal Tax Deposit Type Description
Description: Tier two of a two-tier hierarchy for capturing federal tax deposits from various sources.
Data Type: STRING
Is Required: 1
'''

# Field Name: tax_deposit_today_amt
'''
Display Name: Federal Tax Deposits Today
Description: The total value of federal tax deposits for the day. All figures are rounded to the nearest million.
Data Type: CURRENCY0
Is Required: 1
'''

# Field Name: tax_deposit_mtd_amt
'''
Display Name: Federal Tax Deposits Month to Date
Description: The month to date value of federal tax deposits for the month. All figures are rounded to the nearest million.
Data Type: CURRENCY0
Is Required: 1
'''

# Field Name: tax_deposit_fytd_amt
'''
Display Name: Federal Tax Deposits Fiscal Year to Date
Description: The fiscal year to date value of federal tax deposits for the fiscal year. All figures are rounded to the nearest million.
Data Type: CURRENCY0
Is Required: 1
'''
...
def format_data(data):
    ...
    numeric_cols = [
        'tax_deposit_today_amt', 'tax_deposit_mtd_amt', 'tax_deposit_fytd_amt'
    ]
...
endpoint_details = {
    ...
    'params': {
        'fields': ','.join([
            'record_date', 'tax_deposit_type', 'tax_deposit_type_desc', 'tax_deposit_today_amt',
            'tax_deposit_mtd_amt', 'tax_deposit_fytd_amt', 'table_nbr', 'table_nm', 'sub_table_name',
