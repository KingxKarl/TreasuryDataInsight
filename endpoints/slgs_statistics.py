...
def format_data(data):
    ...
    numeric_cols = [
        'securities_outstanding_cnt', 'principal_outstanding_amt'
    ]
...
endpoint_details = {
    ...
    'params': {
        'fields': ','.join([
            'record_date', 'security_type', 'security_type_desc', 'securities_outstanding_cnt', 
            'principal_outstanding_amt', 'src_line_nbr', 'record_fiscal_year', 'record_fiscal_quarter', 
