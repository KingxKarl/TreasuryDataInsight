...
def format_data(data):
    ...
    numeric_cols = [
        'current_year_proj_tril_amt', 'previous_year_proj_tril_amt', 'proj_tril_amt_change',
        'current_year_percent_of_gdp', 'previous_year_percent_of_gdp', 'percent_of_gdp_change'
    ]
...
endpoint_details = {
    ...
    'params': {
        'fields': ','.join([
            'record_date', 'account_desc', 'line_item_desc', 'current_year_proj_tril_amt',
            'previous_year_proj_tril_amt', 'proj_tril_amt_change', 'current_year_percent_of_gdp',
            'previous_year_percent_of_gdp', 'percent_of_gdp_change', 'src_line_nbr', 'record_fiscal_year',
