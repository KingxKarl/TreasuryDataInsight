...
def format_data(data):
    ...
    df['fiscal_year_amt'] = pd.to_numeric(df['fiscal_year_amt'].str.replace(',', '').str.replace('$', ''), errors='coerce')
...
endpoint_details = {
    ...
    'params': {
        'fields': ','.join([
            ...
            'component_desc', 'line_item_desc', 'irc_section_cd', 'fiscal_year_amt', 'src_line_nbr',
