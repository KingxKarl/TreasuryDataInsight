...
def format_data(data):
    ...
    numeric_cols = [
        'days_to_maturity', 'bids_tendered_mil_amt', 'bids_acc_total_mil_amt',
        'bids_acc_comp_basis_mil_amt', 'bids_acc_noncomp_basis_mil_amt',
        'high_price_per_hundred', 'high_discount_rate', 'high_investment_rate'
    ]
...
endpoint_details = {
    ...
    'params': {
        'fields': ','.join([
            'record_date', 'issue_date', 'maturity_date', 'days_to_maturity',
            'bids_tendered_mil_amt', 'bids_acc_total_mil_amt', 'bids_acc_comp_basis_mil_amt',
            'bids_acc_noncomp_basis_mil_amt', 'high_price_per_hundred', 'high_discount_rate',
            'high_investment_rate', 'src_line_nbr', 'record_fiscal_year', 'record_fiscal_quarter',
