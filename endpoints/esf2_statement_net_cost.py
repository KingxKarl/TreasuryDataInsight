...
def format_data(data):
    ...
    currency_cols = ['current_quarter_thous_amt', 'fytd_thous_amt']
...
endpoint_details = {
    ...
    'params': {
        'fields': ','.join([
            'record_date', 'report_date', 'classification_desc', 'current_quarter_thous_amt', 
            'fytd_thous_amt', 'src_line_nbr', 'record_fiscal_year', 'record_fiscal_quarter', 
