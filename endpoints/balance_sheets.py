...
def format_data(data):
    ...
    df['stmt_fiscal_year'] = pd.to_numeric(df['stmt_fiscal_year'], errors='coerce')
    df['position_bil_amt'] = pd.to_numeric(df['position_bil_amt'].str.replace(',', '').str.replace('$', ''), errors='coerce')
...
endpoint_details = {
    ...
    'params': {
        'fields': ','.join([
            ...
            'line_item_desc', 'position_bil_amt', 'src_line_nbr', 'record_fiscal_year',
