...
endpoint_details = {
    ...
    'params': {
        'fields': ','.join([
            'record_date', 'debt_holder_type', 'security_class1_desc', 'security_class2_desc', 'principal_mil_amt', 
            'accrued_int_payable_mil_amt', 'net_unamortized_mil_amt', 'src_line_nbr', 'record_fiscal_year', 
