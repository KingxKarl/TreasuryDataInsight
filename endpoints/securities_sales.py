...
def format_data(data):
    ...
    numeric_cols = [
        'securities_sold_cnt', 'gross_sales_amt', 'returned_sales_amt', 'net_sales_amt'
    ]
...
endpoint_details = {
    ...
    'params': {
        'fields': ','.join([
            'record_date', 'security_type_desc', 'security_class_desc', 'securities_sold_cnt',
            'gross_sales_amt', 'returned_sales_amt', 'net_sales_amt', 'trans_month',
