...
def format_data(data):
    ...
    numeric_cols = [
        'current_month_budget_amt', 'current_fytd_budget_amt', 'prior_fytd_budget_amt',
        'current_year_budget_est_amt', 'next_year_budget_est_amt'
    ]
...
endpoint_details = {
    ...
    'params': {
        'fields': ','.join([
            ...
            'current_month_budget_amt', 'current_fytd_budget_amt', 'prior_fytd_budget_amt',
            'current_year_budget_est_amt', 'next_year_budget_est_amt', 'table_nbr', 'src_line_nbr',
            'print_order_nbr', 'line_code_nbr', 'data_type_cd', 'record_type_cd', 'sequence_level_nbr',
            'sequence_number_cd', 'record_fiscal_year', 'record_fiscal_quarter', 'record_calendar_year',
