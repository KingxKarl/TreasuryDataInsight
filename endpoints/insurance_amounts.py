...
def format_data(data):
    ...
    numeric_cols = [
        'social_security_tril_amt', 'medicare_hi_tril_amt', 'medicare_smi_tril_amt',
        'other_tril_amt', 'total_tril_amt'
    ]
...
endpoint_details = {
    ...
    'params': {
        'fields': ','.join([
            ...
            'social_security_tril_amt', 'medicare_hi_tril_amt', 'medicare_smi_tril_amt', 'other_tril_amt', 
            'total_tril_amt', 'src_line_nbr', 'record_fiscal_year', 'record_fiscal_quarter',
