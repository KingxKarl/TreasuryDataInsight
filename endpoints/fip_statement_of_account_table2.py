...
endpoint_details = {
    ...
    'params': {
        'fields': ','.join([
            'record_date', 'account_number_tas', 'account_name', 'date_range', 'sub_category', 'line_item_nm',
            'beginning_balance', 'net_change', 'ending_balance', 'src_line_nbr', 'record_fiscal_year', 'record_fiscal_quarter',
