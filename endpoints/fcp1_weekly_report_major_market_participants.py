...
def format_data(data):
    ...
    numeric_cols = [
        'spot_fwd_future_purch_amt', 'spot_fwd_future_sold_amt', 'net_options_positions_amt', 'exchange_rate'
    ]
...
endpoint_details = {
    ...
    'params': {
        'fields': ','.join([
            ...
            'spot_fwd_future_sold_amt', 'net_options_positions_amt', 'exchange_rate', 'src_line_nbr',
