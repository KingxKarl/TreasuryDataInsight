...
def format_data(data):
    ...
    numeric_cols = [
        'securities_redeemed_cnt', 'securities_redeemed_amt'
    ]
...
endpoint_details = {
    ...
    'params': {
        'fields': ','.join([
            'record_date', 'security_type_desc', 'security_class_desc', 'securities_redeemed_cnt', 
            'securities_redeemed_amt', 'trans_month', 'src_line_nbr', 'record_fiscal_year', 
